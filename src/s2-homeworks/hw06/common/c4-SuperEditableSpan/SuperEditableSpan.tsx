...
const SuperEditableSpan: React.FC<SuperEditableSpanType> = (
    ...
    const onBlurCallback = (e: React.FocusEvent<HTMLInputElement>) => {
        setEditMode(!editMode);// выключить editMode при нажатии за пределами инпута // делают студенты
    ...
    const onDoubleClickCallBack = (
        ...
        setEditMode(!editMode);// включить editMode при двойном клике // делают студенты
